...
export const PopupGroup = (_a) => {
    var { sizes, section, withFixItems } = _a, group = __rest(_a, ["sizes", "section", "withFixItems"]);
    ...
    return (React.createElement("div", { className: b(), style: { backgroundColor: group.backgroundColor } },
