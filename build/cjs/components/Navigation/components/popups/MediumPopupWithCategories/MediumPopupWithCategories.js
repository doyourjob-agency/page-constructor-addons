...
const MediumPopupWithCategories = ({ data }) => {
    const breakpoint = (0, page_constructor_1.useWindowBreakpoint)();
    ...
    const isDesktop = breakpoint > page_constructor_1.BREAKPOINTS.lg;
    ...
    return (react_1.default.createElement(page_constructor_1.Row, { className: b() },
        data.groups.map(({ title, items, imageSize }) => (react_1.default.createElement(page_constructor_1.Col, { key: title, className: b('col'), sizes: {
                [page_constructor_1.GridColumnSize.Xl]: 6,
                [page_constructor_1.GridColumnSize.Lg]: 12,
                [page_constructor_1.GridColumnSize.All]: 12,
            } },
            title && (react_1.default.createElement(page_constructor_1.Row, null,
                react_1.default.createElement(page_constructor_1.Col, { className: b('title') },
                    react_1.default.createElement(page_constructor_1.Title, { title: { text: title, textSize: 'xs' } })))),
            !isDesktop && (react_1.default.createElement("div", null,
                react_1.default.createElement(page_constructor_1.Row, null, items.map((item) => (react_1.default.createElement(NavigationPopupItem_1.NavigationPopupItem, Object.assign({}, item, { hover: true, imageSize: imageSize, sizes: {
                        [page_constructor_1.GridColumnSize.Lg]: 6,
                        [page_constructor_1.GridColumnSize.Md]: 4,
                        [page_constructor_1.GridColumnSize.All]: 4,
                    }, key: item.title })))))))))),
        isDesktop && (react_1.default.createElement(page_constructor_1.Col, { className: b('items') },
            react_1.default.createElement("div", null,
                react_1.default.createElement(page_constructor_1.Row, null, desktopItemsArray.map((item, index) => {
                    return typeof item === 'undefined' ? (react_1.default.createElement(page_constructor_1.Col, { sizes: {
