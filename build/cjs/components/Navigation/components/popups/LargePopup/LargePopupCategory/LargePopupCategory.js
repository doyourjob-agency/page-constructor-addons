...
exports.LargePopupCategory = void 0;
const tslib_1 = require("tslib");
const react_1 = tslib_1.__importDefault(require("react"));
const cn_1 = require("../../../../../../utils/cn");
const b = (0, cn_1.block)('large-popup-category');
const LargePopupCategory = ({ data, onClick, isActive }) => {
    const { title } = data;
...
exports.LargePopupCategory = LargePopupCategory;
